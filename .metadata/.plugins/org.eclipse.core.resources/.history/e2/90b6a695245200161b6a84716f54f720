...
public class DonorRegistrationForm extends JFrame {
	...
	private static String titleText = "Test";
	...
	public DonorRegistrationForm(){
		...
		*/
		...
		mobileNumberLabel.setBounds(20, 20, 200, 20);
		nameLabel = new JLabel("Donor Full Name:");
		nameLabel.setBounds(20, 50, 200, 20);
		bloodGroupLabel = new JLabel("Donor Blood Group:");
		bloodGroupLabel.setBounds(20, 80, 200, 20);
		sexLabel = new JLabel("Donor Sex:");
		sexLabel.setBounds(20, 110, 200, 20);
		addressLabel = new JLabel("Donor Address:");
		addressLabel.setBounds(20, 140, 200, 20);
		emailLabel = new JLabel("Donor Email:");
		emailLabel.setBounds(20, 170, 200, 20);
		alternativeMobileNumberLabel = new JLabel("Donor Alternative Mobile Number:");
		alternativeMobileNumberLabel.setBounds(20, 200, 200, 20);
		
		mobileNumberTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 20, 200, 20);
		nameTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 50, 200, 20);
		bloodGroupTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 80, 200, 20);
		sexTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 110, 200, 20);
		addressTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 140, 200, 20);
		emailTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 170, 200, 20);
		alternativeMobileNumberTextField = new JTextField(30);
		mobileNumberTextField.setBounds(240, 200, 200, 20);
